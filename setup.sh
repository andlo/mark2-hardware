...
cp sj201/xvf3510-flash /opt/mark2-hardware/sj201/xvf3510-flash
cp sj201/app_xvf3510_int_spi_boot_v4_2_0.bin /opt/mark2-hardware/sj201/app_xvf3510_int_spi_boot_v4_2_0.bin
cp sj201/init_tas5806.py /opt/mark2-hardware/sj201/init_tas5806.py
chmod 0755 /opt/mark2-hardware/sj201/*

# Enable mark2-hardware systemd unit
echo "Copying mark2-hardware systemd unit file..."
cp mark2-hardware.service /etc/systemd/system/mark2-hardware.service
