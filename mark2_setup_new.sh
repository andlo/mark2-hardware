...
mkdir -p /opt/sj201
curl -L -o /opt/sj201/xvf3510-flash "https://raw.githubusercontent.com/OpenVoiceOS/ovos-buildroot/0e464466194f58553af11c34f7435dba76ec70a3/buildroot-external/package/vocalfusion/xvf3510-flash"
curl -L -o /opt/sj201/app_xvf3510_int_spi_boot_v4_2_0.bin "https://raw.githubusercontent.com/OpenVoiceOS/ovos-buildroot/c67d7f0b7f2a3eff5faab96d6adf7495e9b48b93/buildroot-external/package/vocalfusion/app_xvf3510_int_spi_boot_v4_2_0.bin"
curl -L -o /opt/sj201/init_tas5806 "https://raw.githubusercontent.com/MycroftAI/mark-ii-hardware-testing/main/utils/init_tas5806.py"
chmod 0755 /opt/sj201/*

# Create SJ201 systemd unit file
echo "Copying SJ201 systemd unit file..."
cat <<EOF | tee /etc/systemd/system/sj201.service > /dev/null
[Unit]
...
cp compile_vocalfusion.sh /opt/compile_vocalfusion.sh
chmod +x /opt/compile_vocalfusion.sh

echo "Enabling compile_vocalfussion systemd unit..."
systemctl daemon-reload
systemctl enable compile_vocalfusion.service
